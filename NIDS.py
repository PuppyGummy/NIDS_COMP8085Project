...
X_important_train = X_train[:, selected_features_indices]
X_important_valid = X_valid[:, selected_features_indices]
X_important_test = X_test[:, selected_features_indices]
